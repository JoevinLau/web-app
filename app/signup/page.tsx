...
export default function SignupPage() {
  ...
  async function handlesubmission(formData: FormData) {
    ...
    // Hardcoded logic to prevent duplicates
    const existingusername = "edric";
    const existingemail = "edric@gmail.com";

    if (username === existingusername) {
      setError("Username already exists. Try another user.");
      return;
    }

    if (email === existingemail) {
      setError("This email is already in use! Try another email.");
      return;
    }

    alert(`Account created successfully! Welcome, ${username}. Please Login.`);
